...
import { getStrapiThumbnailMedia } from '@/lib/media';
            ...
            {comics.length &&
              comics.map((comic: any) => {
                return (
                  ...
                  >
                    <Image
                      src={getStrapiThumbnailMedia(
                        comic.attributes.comic.data[0].attributes
                      )}
                      alt={comic.attributes.title}
                      width={56}
                      height={56}
                      className="rounded-3xl object-cover mr-5"
                    />
